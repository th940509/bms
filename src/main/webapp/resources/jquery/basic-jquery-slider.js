...
(function($){
	...
	var defaults = {
		...
		showControls: true,			// Show the manual slider controls 수동 슬라이더 컨트롤 표시
		centerControls: true,		// Center the controls vertically 컨트롤을 세로로 중앙에 배치
		nextText: 'Next',			// Text to display in 'next' controller
		prevText: 'Prev',			// Text to display in 'previous' controller
		showMarkers: true,			// Show positional markers 위치 마커 표시
		centerMarkers: true,		// Center the positional indicators 위치 표시기를 중앙에 배치
